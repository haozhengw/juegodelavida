...
# Constantes
ANCHO = int(input("intorduce ancho de la cuadrícula"))
ALTO = int(input("intorduce altura de la cuadrícula"))

VIVO = input("introduce el carácter que quieres precentar para la celda viva")  # Carácter para la celda viva
